            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">Plasama Donation </h3>
                        <br>
                        <a  type="button" class="btn btn-info" onclick="myFunction()"  style="padding: 2px 6px 2px 6px; margin:10px;">ADD Donor</a>
...
$selectquery = " select * from donateplasama ";
...
?>
                                            ...
                                            <td class="stud_id"><?php echo $res['ID']  ?></td>
                                                ...
                                                <td><?php echo $res['bloodg']  ?></td>
                                                <td><?php echo $res['recoverydate']  ?></td>
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaledit">ADD Donor</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <form action="code/code-donateplasama.php" method="POST">
  ...
  <div class="form-group">
    ...
    <input id="blood1" type="text" name="blood1" class="form-control">
  </div>
  <div class="form-group">
    <label for="recovery1">Last Recovery Date</label>
    <input id="recovery1" type="text" name="recovery1" class="form-control">
  </div>
  <div class="form-group">
...
<div class="modal fade" id="editstudentmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaledit">Update Availability Status </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <div class="form-group">
    <label for="availability1">Availability Status</label>
    <input id="availability1" type="text" name="availability1" class="form-control">
  </div>
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <button type="submit" name="delete" class="btn btn-danger">Delete</button>
    ...
    $(document).ready(function () {
       ...
       $.ajax({
           type: "POST",
           url: "code/code-donateplasama.php",
           data: {
...
$.each(response, function (key, value) { 
    ...
    $('#availability1').val(value['availability']);
