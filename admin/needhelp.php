            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">Need Help Queries </h3>
                        <br>
...
$selectquery = " select * from needhelp ";
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="code/code-needhelp.php" method="POST">
  ...
  <div class="form-group">
    <label for="problem1">Problem</label>
    <input id="problem1" type="text" name="problem1" class="form-control">
  </div>
  <div class="form-group">
    <label for="help1">Help Needed</label>
    <input id="help1" type="text" name="help1" class="form-control">
  </div>
