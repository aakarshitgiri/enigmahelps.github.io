...
$selectquery = "SELECT * FROM volunteer2 WHERE id='$S_id'";
...
if(isset($_POST['update_student']))
{
   ...
   $query = "UPDATE volunteer2 SET  user_name='$user_name', location='$location', password='$pass', name='$name', contact='$contact', email='$email', whatsapp='$whatsapp'   WHERE ID='$id'";
   $query_run= mysqli_query($conn,$query);
   header("Location: ../volunteers2.php");
   exit();
...
if(isset($_POST['delete']))
{
   ...
   $deletequery = "DELETE FROM volunteer2 WHERE id = '$id'";
