            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">Resources Regarding Covid</h3>
                        <br>
                        <a  type="button" class="btn btn-info" onclick="myFunction()"  style="padding: 2px 6px 2px 6px; margin:10px;">ADD Resources</a>
...
?>
                                            ...
                                            <td class="stud_id"><?php echo $res['ID']  ?></td>
                                                ...
                                                <td>Date: <?php echo $res['dateverify']  ?><br>
                                                Time: <?php echo $res['verifytime']  ?></td>
                                               
                                                <td><?php echo $res['enigmaverify']  ?></td>
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaledit">ADD New Resources</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <form action="code/code-resources.php" method="POST">
  ...
  <div class="form-group">
    ...
    <input id="heading1" type="text" name="heading1" class="form-control">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="desription1">Description</label>
    <input style="height: 100px;" id="desription1" type="text" name="desription1" class="form-control">
  </div>

  
 
  <div class="form-group">
    <label for="dateverify1">Date OF Verification</label>
    <input id="dateverify1" type="text" name="dateverify1" class="form-control">
  </div>
  <div class="form-group">
    <label for="verifytime1">Time OF Verification</label>
    <input id="verifytime1" type="text" name="verifytime1" class="form-control">
  </div>
  
<div class="form-group">
    <label for="engimaverify1">Enigma Verification</label>
    <input id="engimaverify1" type="text" name="engimaverify1" class="form-control">
  </div>
...
<div class="modal fade" id="editstudentmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaledit">Update Resources </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <div class="form-group">
    <label for="enigmaverify">Enigma Verification</label>
    <input id="enigmaverify" type="text" name="enigmaverify" class="form-control">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input style="height: 100px;" id="description" type="text" name="description" class="form-control">
  </div>
  <div class="form-group">
    <label for="dateverify">Date of Verification</label>
    <input id="dateverify" type="text" name="dateverify" class="form-control">
  </div>
  <div class="form-group">
    <label for="verifytime">Time of Verification</label>
    <input id="verifytime" type="text" name="verifytime" class="form-control">
  </div>
...
$.each(response, function (key, value) { 
    ...
    $('#enigmaverify').val(value['enigmaverify']);
    $('#heading').val(value['heading']);
    $('#description').val(value['description']);
    $('#dateverify').val(value['dateverify']);
    $('#verifytime').val(value['verifytime']);
