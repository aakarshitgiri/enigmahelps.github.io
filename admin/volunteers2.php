            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4" >Volunteer - Hospital & Oxygen</h3>
                        <br>
                        <a  type="button" class="btn btn-info " onclick="myFunction()"  style="padding: 2px 6px 2px 6px; margin:10px;">ADD Volunteer</a>
...
$selectquery = " select * from volunteer2 ";
...
?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a  type="button" class="btn btn-info view_btn"  style="    margin: 5px; padding: 2px 6px 2px 6px;">View</a> <a  type="button" class="btn btn-secondary edit_btn"  style="    margin: 5px; padding: 2px 6px 2px 6px;">Update</a>  <a  type="button" class="btn btn-danger delete_btn"  style="    margin: 5px; padding: 2px 6px 2px 6px;">Delete</a></td>
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaledit">ADD Volunteer</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <form action="code/code-volunteers3.php" method="POST">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input id="user_name1" type="text" name="user_name1" class="form-control">
  </div>
  <div class="form-group">
...
<div class="modal fade" id="editstudentmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="code/code-volunteers2.php" method="POST">
      <div class="form-group">
...
<footer class="py-4 bg-light mt-auto">
  ...
  $(document).ready(function() {
    ...
    language:{
      search: "_INPUT_",
      searchPlaceholder: "Search Volunteer/City",
    } 
