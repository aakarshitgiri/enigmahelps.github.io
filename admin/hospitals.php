            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">Hospitals & Beds Availability</h3>
                        <br>
                        <a  type="button" class="btn btn-info" onclick="myFunction()"  style="padding: 2px 6px 2px 6px; margin:10px;">ADD Hospital</a>
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaledit">ADD New Member</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <form action="code/code-hospitals.php" method="POST">
  ...
  <div class="form-group">
    <label for="beds1">Beds Availability</label>
    <input id="beds1" type="text" name="beds1" class="form-control">
  </div>
...
<div class="modal fade" id="editstudentmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modaledit">Update Hospital Status </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <div class="form-group">
    <label for="beds">Beds Availabel</label>
    <input id="beds" type="text" name="beds" class="form-control">
  </div>
  <div class="form-group">
