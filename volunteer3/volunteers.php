            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-4">Volunteers Registrations </h3>
                        <br>
...
$selectquery = " select * from joinus ";
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="code/code-volunteers.php" method="POST">
  ...
  <div class="form-group">
    <label for="profession1">Profession</label>
    <input id="profession1" type="text" name="profession1" class="form-control">
  </div>
